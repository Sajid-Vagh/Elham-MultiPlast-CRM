...
export const LoginResponse = zod.object({
  ...
  "name": zod.string(),
  "username": zod.string(),
  "role": zod.enum(['admin', 'sales', 'inventory', 'production', 'production_and_support']),
...
export const UpdateUserBody = zod.object({
  ...
  "role": zod.enum(['admin', 'sales', 'inventory', 'production', 'production_and_support']).optional(),
...
export const ListContactsResponseItem = zod.object({
  ...
  "commentUpdatedByUser": zod.object({
  "id": zod.number(),
  "name": zod.string(),
  "username": zod.string(),
  "role": zod.enum(['admin', 'sales', 'inventory', 'production', 'production_and_support']),
  ...
  "isRepeatEnquiry": zod.boolean().optional(),
  "isReadByAdmin": zod.boolean().optional(),
  "isReadByAssignee": zod.boolean().optional(),
  "readBy": zod.array(zod.number()).optional(),
  "lostReason": zod.string().nullish(),
  "otherReason": zod.string().nullish(),
  "lostNotes": zod.string().nullish(),
...
export const ListDealsQueryParams = zod.object({
  ...
  "unit": zod.coerce.string().optional(),
  "completedDealVisibility": zod.coerce.string().optional(),
...
export const ListDealsResponseItem = zod.object({
  ...
  "isHiddenFromTimeline": zod.boolean().optional(),
  "createdAt": zod.string(),
  "updatedAt": zod.string().optional()
})
...
export const GetReportByStateResponse = zod.object({
  "dealsByState": zod.array(zod.object({
  "state": zod.string(),
  "totalDeals": zod.number(),
  "wonDeals": zod.number(),
  "lostDeals": zod.number(),
