...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListDealProductsQueryKey(id);
   ...
   return  { queryKey, queryFn, enabled: id !== null && id !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listDealProducts>>, TError, TData> & { queryKey: QueryKey }
}
...
export const addDealProduct = async (id: number,
  ...
  return customFetch<DealProduct>(getAddDealProductUrl(id),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(dealProductInput)
  }
);}
...
export const importIndiaMart = async (indiaMartLeadInput: IndiaMartLeadInput, options?: RequestInit): Promise<Contact> => {
  ...
  return customFetch<Contact>(getImportIndiaMartUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(indiaMartLeadInput)
  }
);}
